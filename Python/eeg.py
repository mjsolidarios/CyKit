    ...
    def onData(self, uid, text):
        ...
        if ioCommand[0] == "CyKITv2":
            ...
            if ioCommand[1] == "RecordStart":
                ...
                print
                "[Start] Recording to File: " + ioCommand[2]
...
class EEG(object):
    ...
    def Setup(self, model, config):
        ...
        for device in hid.find_all_hid_devices():
            if "info" in config:
                ...
                print
                "instance id " + device.instance_id
                print
                "_" * 80 + "\r\n"
            useDevice = ""
            for i, findDevice in enumerate(deviceList):
                ...
                if device.product_name == deviceList[i]:
                    ...
                    if useDevice.upper() == "Y":
                        ...
                        print
                        "> Using Device: " + device.product_name + "\r\n"
                        print
    ...
    def run(self, key, myio):
        ...
        for t in threading.enumerate():
            ...
            print
            "   " + str(thread_name[0]) + " ::: " + str(t.getName()) + ">"
        print
        "} \r\n"
        self.lock.release()
                ...
                try:
                    ...
                    try:
                        ...
                        if msg[0] == 9 or msg[0] == 10053 or msg[0] == 10035:
                            ...
                            continue
                        print
                        "eeg().run() sendData() Error: " + str(msg)
